...
function createModal(data){
    currentMovie = data;
  //innerHTML para pegar o html que existe dentro do elemento;
  ...
  <h2 id="movie-title">${data.Title} - ${data.Year}</h2>
                ...
                //onclick="{addCurrentMovieToList()}" assim que eu clicar no botão eu devo chamar minha função addCurrentMovieToList
}
